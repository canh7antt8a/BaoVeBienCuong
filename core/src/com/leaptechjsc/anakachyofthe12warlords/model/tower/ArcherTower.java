...
import com.leaptechjsc.anakachyofthe12warlords.model.bullet.EnumBulletList;
import com.leaptechjsc.anakachyofthe12warlords.model.bullet.IBulletConstants;
import com.leaptechjsc.anakachyofthe12warlords.model.gameObject.EnumDirectionList;
...
public class ArcherTower extends Tower {
	...
	public ArcherTower(int id, Coordinate position, TowerData towerData) {
		super(id, position, towerData);
	}

	@Override
	public void attack(Enemy enemy, Scenario scenario) {
		soundManager.play(SoundDataManager.ARCHER, false);
	...
	public void generateBullet(Enemy enemy, Scenario scenario) {
		if (enemy != null) {
			...
			if (enemy.getSpeed() != 0) {
				double a = EnumBulletList.ARCHER_BULLET.getSpeed()
						/ enemy.getSpeed();
				a = a * a - 1;
				...
				while (true) {
					...
					if (nextMileStone != null) {
						...
						if (delta > remain) {
							...
							float speed = EnumBulletList.ARCHER_BULLET
									.getSpeed();
				...
				float speed = EnumBulletList.ARCHER_BULLET.getSpeed();
